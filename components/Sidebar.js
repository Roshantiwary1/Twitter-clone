...
import {
    ...
    const Sidebar = ({clicked}) => {
      ...
      return (
        ...
        {/* profile */}
       {currentUser && ( <div className={`${select?"text-black hover:bg-gray-200":"text-white hover:bg-gray-800"} hoverEffect  flex items-center xs:top-[3px] sm:mt-auto xs:left-[6px] 
       xs:absolute sm:static`}>
