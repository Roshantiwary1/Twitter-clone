...
const Post = ({post}) => {
  ...
  return (
    ...
    {/* userimage    */}
    <img className="h-11 w-11 rounded-full cursor-pointer mr-4 hover:brightness-95" src={post.data().userImg} alt="user" />
    ...
    {/* post image */}
        <img className='rounded-xl mr-2' src={post.data().image} alt="" />
    {/* icon */}
